...
insert into user (ID, UserName, Password, FirstName, LastName, Phone, Email, IsReviewer, IsAdmin, UpdatedByUser)
   values (1, 'daoph', 'sesame', 'Phuc', 'Dao', '513-288-6412', 'phuc.h.dao@gmail.com', 1, 1,1),
		(2, 'user1', 'password1', 'Phuc1', 'Dao1', '513-288-6411', '1phuc.h.dao@gmail.com', 1, 1,1),
        (3, 'user2', 'password2', 'Phuc2', 'Dao2', '513-288-6412', '2phuc.h.dao@gmail.com', 1, 1,1),
		(4, 'user3', 'password3', 'Phuc3', 'Dao3', '513-288-6413', '3phuc.h.dao@gmail.com', 1, 1,1)
   ;
